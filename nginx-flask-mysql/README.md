...
nginx-flask-mysql-db-1        "docker-entrypoint.sâ¦"   db                  running (healthy)   3306/tcp, 33060/tcp
nginx-flask-mysql-proxy-1     "nginx -g 'daemon ofâ¦"   proxy               running             0.0.0.0:80->80/tcp
```
