...
nginx-golang-postgres-db-1        "docker-entrypoint.sâ¦"   db                  running (healthy)   5432/tcp
nginx-golang-postgres-proxy-1     "/docker-entrypoint.â¦"   proxy               running             0.0.0.0:80->80/tcp
```
