...
dfd49ab7a372   visibilityspots/cloudflared           "/bin/sh -c '/usr/loâ¦"   4 seconds ago   Up 3 seconds (health: starting)   0.0.0.0:5054->5054/tcp, 0.0.0.0:5054->5054/udp                                                            cloudflared
```
