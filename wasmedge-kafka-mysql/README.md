...
$ docker compose up -d
...
 â ¿ Network wasmedge-kafka-mysql_default       Created                      0.1s
 â ¿ Container wasmedge-kafka-mysql-redpanda-1  Created                      0.3s
 â ¿ Container wasmedge-kafka-mysql-etl-1       Created                      0.3s
 â ¿ Container wasmedge-kafka-mysql-db-1        Created                      0.3s
```
...
wasmedge-kafka-mysql-db-1         "docker-entrypoint.sâ¦"   db                  running             3306/tcp
wasmedge-kafka-mysql-etl-1        "kafka.wasm"             etl                 running
wasmedge-kafka-mysql-redpanda-1   "/entrypoint.sh 'redâ¦"   redpanda            running             0.0.0.0:8081-8082->8081-8082/tcp, :::8081-8082->8081-8082/tcp, 0.0.0.0:9092->9092/tcp, :::9092->9092/tcp, 0.0.0.0:9644->9644/tcp, :::9644->9644/tcp, 0.0.0.0:29092->29092/tcp, :::29092->29092/tcp
```
